    ...
    <body>
        ...
        <main class ="container">
            ...
            <section aria-labelledBy="search header" class="d-flex justify-content-between">
                ...
                <h2 class="text-center flex-grow-1"> You are viewing posts related to: <?php echo $categoryObject ?></h2>
            </section>
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item " role="presentation">
                    <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">Related Post (<?php echo $postCountBasedOnCategory ?>)</button>
                </li>
            </ul>
            <!-- Tabs navs -->
                            ...
                            if ($renderPost) {
                                ...
                                <article class="card mt-3 searchResult">
                                    <div class="card-body d-flex align-items-start">
                                        <a href="profile.php?userID=<?= $postRows[3] ?>"><img class="me-2 avatar-sm rounded-circle" src="<?= 'images/profilepics/' . $author['profilePic'] ?>" alt="Generic placeholder image">
                                            ...
                                            <a href="viewPost.php?postID=<?php echo $postRows[2] ?>" class="button three">View Post</a>
                                    </div>
                                </article>
                                <?php
                            }
